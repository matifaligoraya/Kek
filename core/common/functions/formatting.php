 ...
 * @return  int
 */
function kek_sanitize_checkbox_value($value)
{
 ...
 * @return  string
 */
function kek_sanitize_css_input($css)
{
 ...
 * @return  string
 */
function kek_sanitize_color_input($color)
{
 ...
 * @return  string
 */
function kek_sanitize_text_input_recursive($text)
{
    if (is_array($text)) {
        foreach ($text as $k => $v) {
            $text[$k] = kek_sanitize_text_input_recursive($v);
        }
 ...
 * @return  string
 */
function kek_strip_wpbakery_page_builder_shortcodes($content)
{
    static $regex = null;
 ...
 * @return  string
 */
function kek_strip_all_shortcodes($content)
{
    static $regex = null;
