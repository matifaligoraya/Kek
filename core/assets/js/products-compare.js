    ...
    var ZooProductsCompareView = (function () {
        ...
        Constructor.prototype.renderPanel = function (content) {
            ...
            if (this.panel.length) {
                ...
                $('body').append('<div class="products-compare-panel popup-panel" style="display:none"><div class="popup-mask-close loading"></div><button class="products-compare-panel-close-btn popup-close-btn" type="button" name="close-button"><i class="icon-close"></i></button><div class="products-compare-panel-inner popup-inner">' + content + '</div></div>');
            }
        }
        ...
        Constructor.prototype.renderBrowseButton = function (btn) {
            ...
            btn = $('.compare-button[data-id='+btn.data('id')+']');
    ...
    var ZooProductsCompareController = (function () {
        ...
        Constructor.prototype.sync = function (changeEvent) {
            ...
            if ('zooProductsCompareItems' === changeEvent.key) {
                ...
                if (items.length < 1) {
                    $('.products-compare-counter').addClass('hidden');
                }
            }
        };
        ...
        Constructor.prototype.browseAction = function (browseEvent) {
            ...
            if (items.length && !this.doingAJAX) {
                ...
                $.ajax({
                    ...
                    url: ajaxurl,
                    data: {
                        action: 'sublimeplus_get_compare_products',
                    ...
                    self.view.panel.find('.popup-inner').fadeIn();

                });
            } else {
                self.view.panel.find('.popup-inner').fadeIn()
            }
            $(document).trigger('sublimeplus_browse_compare');
        };
