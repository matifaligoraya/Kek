...
(function($, exports)
{
    ...
    var ZooLiveCss = (function()
    {
        ...
        Ctor.prototype.render = function(fieldName)
        {
            ...
            if ($('#google-font-css').length <= 0) {
                $('head').prepend('<link rel="stylesheet" id="google-font-css" href="" media="all">');
            }

            if (url) {
                $('#google-font-css').attr('href', url);
            } else {
                $('#google-font-css').remove();
            }

            css_code = css_code.trim();

            if ($('#style-inline-css').length <= 0) {
                $('head').append("<style id='style-inline-css' type='text/css'></style>")
            }

            $('#style-inline-css').html(css_code);
