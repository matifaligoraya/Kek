<?php
    ...
    class SublimeHomePageBannerTab extends SublimeBaseTab {
        
        public function getTitle() {
            return __('HomePage Banner', 'sublimeplus');
        }
        public function renderopen()
        {
            echo '<div class="tab-pane" id="homepage-banner-settings" role="tabpanel" aria-labelledby="homepage-banner-settings_">';
        ...
        public function render() {
            ...
            $this->renderopen();
            ?>
   <?php $show_banner_on_home = intval($this->getValue('show_banner_on_home')) ?>
   <div class="mb-3">
       <label class="form-label"><?php esc_html_e('Show Banner On HomePage', 'sublimeplus') ?></label>
       <input type="checkbox" class="" name="<?php echo esc_attr($this->getName('show_banner_on_home')) ?>"
           value="1" <?php if ($show_banner_on_home) echo ' checked'; ?>>
       <small
           class="form-text"><?php esc_html_e('Whether to enable banner on homepage.', 'sublimeplus'); ?></small>
   </div>
