...
class kek_Customize_Importer extends WP_Customize_Setting
{
    /**
     * Do import
     */
        ...
        foreach ($mods as $key => $mod) {
            ...
            if (!is_wp_error($data)) {
                ...
                if (isset($mods[$key.'_data'])) {
                    $mods[$key.'_data'] = $data;
                    update_post_meta($data->attachment_id, '_wp_attachment_is_custom_header', kek_CHILD_THEME_SLUG);
                }
            }
        }
