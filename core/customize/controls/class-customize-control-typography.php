<?php
/**
 * kek_Customize_Control_Typography
 *
 * @package KeK\Core\Customize\Classes\Controls
 *
 */
final class kek_Customize_Control_Typography extends kek_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?><script type="text/html" id="tmpl-customize-control-typography">
        <#
        var required = '';
        ...
        <div class="customize-control customize-control-{{ data.type }} {{ data.class }} customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            <div class="customize-control-settings-inner">
                <input type="hidden" class="typography-input only" data-name="{{ data.name }}" value="{{ JSON.stringify( data.value ) }}" data-default="{{ JSON.stringify( data.default ) }}">
            </div>
        </div>
        </script>
        <div id="typography-panel" class="typography-panel">
            <div class="typography-panel--inner">
                <input type="hidden" id="font-type">
                <div id="typography-panel--fields"></div>
            </div>
        </div>
        <?php
    }
