<?php
/**
 * kek_Customize_Control_Upload
 *
 * @package KeK\Core\Customize\Classes\Controls
 *
 */
final class kek_Customize_Control_Upload extends kek_Customize_Control_Media
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-customize-control-upload">
        <#
        var required = '';
