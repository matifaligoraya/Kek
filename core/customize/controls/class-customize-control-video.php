<?php
/**
 * kek_Customize_Control_Video
 *
 * @package KeK\Core\Customize\Classes\Controls
 *
 */
final class kek_Customize_Control_Video extends kek_Customize_Control_Media
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-customize-control-video">
        <#
        var required = '';
