<?php
/**
 * kek_Customize_Control_Modal
 *
 * @package KeK\Core\Customize\Classes\Controls
 *
 */
class kek_Customize_Control_Modal extends kek_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-customize-control-modal">
        <#
        var required = '';
